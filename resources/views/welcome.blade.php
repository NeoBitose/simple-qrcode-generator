  ...
  <div class="container">
    <section id="content">
      <form method="post" action="/generate" enctype="multipart/form-data" >
        ...
        <div>
          <input name="link" type="text" placeholder="Masukkan link anda" required="" id="username" />
        </div>
        <div>
          <input type="submit" value="Buat QrCode" />
          <a href="https://github.com/NeoBitose/simple-qrcode-generator">Open Github</a>
        </div>
      </form><!-- form -->
